...
Or if you have an aversion to piping scripts over the internet into bash, download the [Superlumic script](https://raw.githubusercontent.com/superlumic/superlumic/master/superlumic) and run it.
...
```bash
curl -s https://raw.githubusercontent.com/superlumic/superlumic/master/superlumic | bash -s <your repo clone url here> myuser
```
Then "myuser.yml" will be used.
